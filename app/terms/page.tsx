        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              законодательство Республики Казахстан, а также контент,
          ...
          <section>
            ...
            <p>
              Все платежи производятся через платёжные системы Kaspi Pay,
              Halyk Bank или банковскую карту. Оплата публикации объявления
              не возвращается после его публикации.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              качество или результат сотрудничества между бизнесом и
              создателями контента. Все договорённости и расчёты между
              сторонами происходят напрямую.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Мы не передаём ваши персональные данные третьим лицам без
              вашего согласия, кроме случаев, предусмотренных законодательством
